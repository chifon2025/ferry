...
(function(root,factory){const api=factory(typeof module==='object'&&module.exports?require('./scenario-data.js'):root.FerryScenarioData);if(typeof module==='object'&&module.exports)module.exports=api;else root.FerryReframeCore=api;})(typeof window==='object'?window:globalThis,function(data){
  ...
  const definitions=[
    {id:'s041',reactions:[
      ['你懂什麼，我熬了一整晚耶！','熬夜做的努力被一句話帶過，難免不甘心。也許我在意的是：先看清楚我的付出，再給具體的意見。'],
      ['他是不是覺得我很沒用？','我很希望自己做得好。但「這份報告還能改」和「我整個人很差」，並不是同一件事。'],
      ['算了啦，做再多也沒人看見。','我可能累了，也不想再受打擊。現在不用決定以後都不做；先處理眼前這一份就好。']
    ],actions:[
    ...
    {id:'s003',reactions:[
      ['又來了，每次都讓我等！','我的時間也重要。生氣提醒我很在意約定；我可以把時間界線說清楚，不必用爭吵才能表達。'],
      ['他根本沒把我放在心上吧？','等不到人，很容易連自己的重要性也一起懷疑。目前知道的是他塞車，還不知道這代表他怎麼看我。'],
      ['想催，又怕他覺得我很煩。','我可能怕一開口就傷和氣。但想知道還要等多久，是一個可以直接提出的需要。']
    ],actions:[
    ...
    {id:'s201',reactions:[
      ['都已讀了，為什麼不回？','我想被回應，也在意這段關係。但已讀只告訴我訊息被看過，還不能替對方說明所有原因。'],
      ['是不是我剛才講錯什麼？','我怕自己的話讓人不舒服。目前沒有足夠資訊證明自己說錯了，不必先把責任全攬過來。'],
      ['要不要再傳一句，當作沒事？','我想趕快確定關係沒事。可以先看看：我是真的有新事情要說，還是正在等一個讓自己安心的訊號？']
    ],actions:[
    ...
    {id:'s096',reactions:[
      ['怎麼又是我？當我都沒事嗎？','我想互相幫忙，也希望自己的休息被尊重。這次有怨氣，可能是在提醒我：答應前先看看自己還有多少餘力。'],
      ['如果拒絕，他會不會覺得我很難搞？','我在意關係，不想讓人失望。但有界線不等於不近人情；我可以好好說，不必保證對方一定滿意。'],
      ['算了，答應比較快，忍一下就好。','我可能習慣先讓別人方便。但自己的休息也是需要，這一次可以把它一起算進決定裡。']
    ],actions:[
    ...
    {id:'s131',reactions:[
      ['明明是他先惹我的！','我也有委屈，原本的問題需要談。但對自己的用語負責，不代表對方的做法就全都沒問題。'],
      ['糟了，我是不是把事情搞砸了？','我在意這段關係，也不喜歡剛才的自己。可以承認那句話傷人，不必把自己整個人判成失敗。'],
      ['現在道歉，不就像全是我的錯？','我可能怕尷尬，也不知道怎麼開口。不用一次把所有事修好，可以先承認剛才那一句。']
    ],actions:[
